...
class InsufficientAmountException(exceptions.FailedPreCondition):
...
class CheckoutSessionMixin(object):
    ...
    def check_pre_conditions(self, request):
        ...
        # CUSTOM PRE CONDITION 
        #   1. Voldoet de basket aan de minimum vereist verkoopsafname? 
        self.check_minimum_purchase_amount(request)
